  ...
  <div class="auth-container">
    ...
    <div class="auth-form">
      ...
      <div class="form-group">
        ...
        <input type="text" id="register-nickname" class="form-control">
      </div>
      <div class="form-group">
...
'user-settings': `
  <div class="settings-container">
    ...
    <div class="user-info-header">
      <img id="settings-avatar" class="user-avatar-large" src="" alt="头像">
      <div>
        <h2 id="settings-username"></h2>
        <input type="file" id="avatar-upload" accept="image/*" style="display: none;">
        <button class="btn-avatar" id="change-avatar-btn">更换头像</button>
      </div>
    </div>
    <div class="setting-card">
      ...
      <div class="setting-body">
        <div class="setting-item">
          ...
          <input type="text" id="settings-nickname" class="form-control">
        </div>
      </div>
    </div>
    <div class="setting-card">
